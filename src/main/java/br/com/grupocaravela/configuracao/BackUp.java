...
public class BackUp {
	...
	public void salvar(String nome) {
		...
		if ("Linux".equals(System.getProperty("os.name"))) {
			dumps = new String[] {"/bin/sh", "-c", "mysqldump -h " + lerArquivoIp() + " -u root -ppeperoni cheque > " + nome + ".sql"};
			//JOptionPane.showMessageDialog(null, "PASSIE AKI");
		} else {
			dumps = new String[] {"cmd.exe", "/c", "C:\\GrupoCaravela\\mysqldump.exe -h " + lerArquivoIp() + " -u root -ppeperoni cheque > " + nome + ".sql"};
		}
	...
	private void upload(String nome){
		...
		if ("Linux".equals(System.getProperty("os.name"))) {
			dumps = new String[] {"/bin/sh", "-c","mysql -h " + lerArquivoIp() + " -u root -ppeperoni cheque < " + nome};
			//JOptionPane.showMessageDialog(null, "PASSIE AKI");
		} else {
			 //dump = "cmd.exe /c mysqldump -h localhost -u root -ppeperoni cheque > //tmp/" + nomeBkp;
			dumps = new String[] {"cmd.exe", "/c", "C:\\GrupoCaravela\\mysql.exe -h " + lerArquivoIp() + " -u root -ppeperoni cheque < " + nome};
