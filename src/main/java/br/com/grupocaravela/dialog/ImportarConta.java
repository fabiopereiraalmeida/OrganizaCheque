...
public class ImportarConta extends JDialog {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ImportarConta frame = new ImportarConta();
	...
	private void carregarJanela(){
		...
		btnFiltrar.setIcon(new ImageIcon(ImportarConta.class.getResource("/br/com/grupocaravela/icones/lupa_24.png")));
		...
		btnNovo.setIcon(new ImageIcon(ImportarConta.class.getResource("/br/com/grupocaravela/icones/novo_24.png")));
		...
		btnDetalhes.setIcon(new ImageIcon(ImportarConta.class.getResource("/br/com/grupocaravela/icones/alterar_24.png")));
		
		JButton btnImportar = new JButton("Importar");
		btnImportar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				
				conta = tableModelConta.getConta(table.getSelectedRow());
				dispose();
				
			}
		});
		btnImportar.setIcon(new ImageIcon(ImportarConta.class.getResource("/br/com/grupocaravela/icones/aprovar_24.png")));
		...
		btnSalvar.setIcon(new ImageIcon(ImportarConta.class.getResource("/br/com/grupocaravela/icones/alerta_verde_24.png")));
		...
		btnCancelar.setIcon(new ImageIcon(ImportarConta.class.getResource("/br/com/grupocaravela/icones/alerta_amarelo_24.png")));
					...
					.addGroup(gl_panel_6.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_panel_6.createSequentialGroup()
							...
							.addGroup(gl_panel_6.createParallelGroup(Alignment.LEADING)
								...
								.addComponent(cbAgencia, GroupLayout.PREFERRED_SIZE, 379, GroupLayout.PREFERRED_SIZE)))
		...
		final Thread tr = new Thread(new Runnable() {
			...
			public void run() {
				try {
					...
					Logger.getLogger(ImportarConta.class.getName()).log(Level.SEVERE, null, ex);
				}
				// ######################METODO A SER
				// EXECUTADO##############################
				limparTabela();
