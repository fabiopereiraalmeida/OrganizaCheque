...
public class ImportarAgencia extends JDialog {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ImportarAgencia frame = new ImportarAgencia();
	...
	private void carregarJanela() {
		...
		btnFiltrar.setIcon(new ImageIcon(ImportarAgencia.class.getResource("/br/com/grupocaravela/icones/lupa_24.png")));
		...
		btnNovo.setIcon(new ImageIcon(ImportarAgencia.class.getResource("/br/com/grupocaravela/icones/novo_24.png")));
		...
		btnDetalhes
				.setIcon(new ImageIcon(ImportarAgencia.class.getResource("/br/com/grupocaravela/icones/alterar_24.png")));
		
		JButton button = new JButton("Impotar");
		button.setIcon(new ImageIcon(ImportarAgencia.class.getResource("/br/com/grupocaravela/icones/aprovar_24.png")));
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				
				agencia = tableModelAgencia.getAgencia(table.getSelectedRow());
				dispose();
		...
		btnSalvar.setIcon(
				new ImageIcon(ImportarAgencia.class.getResource("/br/com/grupocaravela/icones/alerta_verde_24.png")));
		...
		btnCancelar.setIcon(
				new ImageIcon(ImportarAgencia.class.getResource("/br/com/grupocaravela/icones/alerta_amarelo_24.png")));
		...
		final Thread tr = new Thread(new Runnable() {
			...
			public void run() {
				try {
					...
					Logger.getLogger(ImportarAgencia.class.getName()).log(Level.SEVERE, null, ex);
				}
				// ######################METODO A SER
				// EXECUTADO##############################
				limparTabela();
