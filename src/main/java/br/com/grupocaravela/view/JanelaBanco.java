...
public class JanelaBanco extends JFrame {
	...
	private void carregarJanela(){
		...
		btnFiltrar.setIcon(new ImageIcon(JanelaBanco.class.getResource("/br/com/grupocaravela/icones/lupa_24.png")));
		...
		btnNovo.setIcon(new ImageIcon(JanelaBanco.class.getResource("/br/com/grupocaravela/icones/novo_24.png")));
		...
		btnDetalhes.setIcon(new ImageIcon(JanelaBanco.class.getResource("/br/com/grupocaravela/icones/alterar_24.png")));
		...
		btnExcluir.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				int i = JOptionPane.showOptionDialog(null,
						"ATENÇÃO!!! Esta operação irá excluir o banco selecionado! Gostaria de continuar?",
		...
		btnExcluir.setIcon(new ImageIcon(JanelaBanco.class.getResource("/br/com/grupocaravela/icones/alerta_vermelho_24.png")));
		...
		btnSalvar.setIcon(new ImageIcon(JanelaBanco.class.getResource("/br/com/grupocaravela/icones/alerta_verde_24.png")));
		...
		btnCancelar.setIcon(new ImageIcon(JanelaBanco.class.getResource("/br/com/grupocaravela/icones/alerta_amarelo_24.png")));
	...
	private void botaoExcluir(){
		...
		banco = tableModelBanco.getBanco(linhaReal);
		excluirBanco(banco);
		limparTabela();
	}
		...
		final Thread tr = new Thread(new Runnable() {
			...
			public void run() {
				try {
					...
					Logger.getLogger(JanelaBanco.class.getName()).log(Level.SEVERE, null, ex);
				}
				// ######################METODO A SER
				// EXECUTADO##############################
				limparTabela();
