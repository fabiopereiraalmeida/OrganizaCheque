...
public class JanelaProprietario extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					JanelaProprietario frame = new JanelaProprietario();
	...
	private void carregarJanela(){
		...
		btnFiltrar.setIcon(new ImageIcon(JanelaProprietario.class.getResource("/br/com/grupocaravela/icones/lupa_24.png")));
		...
		btnNovo.setIcon(new ImageIcon(JanelaProprietario.class.getResource("/br/com/grupocaravela/icones/novo_24.png")));
		...
		btnDetalhes.setIcon(new ImageIcon(JanelaProprietario.class.getResource("/br/com/grupocaravela/icones/alterar_24.png")));
		...
		btnExcluir.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				int i = JOptionPane.showOptionDialog(null,
						"ATENÇÃO!!! Esta operação irá excluir o proprietario selecionado! Gostaria de continuar?",
		...
		btnExcluir.setIcon(new ImageIcon(JanelaProprietario.class.getResource("/br/com/grupocaravela/icones/alerta_vermelho_24.png")));
		...
		btnSalvar.setIcon(new ImageIcon(JanelaProprietario.class.getResource("/br/com/grupocaravela/icones/alerta_verde_24.png")));
		...
		btnCancelar.setIcon(new ImageIcon(JanelaProprietario.class.getResource("/br/com/grupocaravela/icones/alerta_amarelo_24.png")));
	...
	private void botaoExcluir(){
		...
		Proprietario = tableModelProprietario.getProprietario(linhaReal);
